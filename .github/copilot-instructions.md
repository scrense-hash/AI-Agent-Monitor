...
Общие правила и язык взаимодействия

Важно: Всегда придерживайся следующих правил при ответах в чате и генерации кода.

    Язык общения: Всегда отвечай, задавай уточняющие вопросы и предоставляй объяснения исключительно на русском языке.

    Язык комментариев и документации: Весь генерируемый или изменяемый код должен содержать комментарии и docstrings на русском языке. Это необходимо для поддержания единого стиля в проекте.

    Пользовательские строки: Любые текстовые строки в коде, предназначенные для вывода пользователю (например, в логах, интерфейсе или консоли), должны быть на русском языке.

    Соблюдение контекста: Внимательно следуй описанной ниже архитектуре. Твои предложения должны быть совместимы с существующей структурой проекта, особенно с системой плагинов и оркестратором LLM.
